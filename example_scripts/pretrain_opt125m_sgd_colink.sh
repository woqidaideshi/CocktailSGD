...
--project-name cocktail-allreduce-p2p-sgd \
--model-type opt \
--optimizer adam \
--seed 42 \
--task-name cot \
--checkpoint-path ./model_ckpts/$WANDB_NAME-sgd-colink \
...
--dist-url tcp://10.133.70.2:5000 \
--world-size 3 --pipeline-group-size 1 --data-group-size 3 \
